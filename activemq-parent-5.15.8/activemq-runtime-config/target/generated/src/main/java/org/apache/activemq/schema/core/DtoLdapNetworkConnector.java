...
public class DtoLdapNetworkConnector implements Equals, HashCode, ToString
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the bridgeFactoryOrBrokerServiceOrConnectionFilter property.
     * 
     * <p>
     ...
     * {@link JAXBElement }{@code <}{@link DtoLdapNetworkConnector.BridgeFactory }{@code >}
    ...
    public List<Object> getBridgeFactoryOrBrokerServiceOrConnectionFilter() {
        if (bridgeFactoryOrBrokerServiceOrConnectionFilter == null) {
            bridgeFactoryOrBrokerServiceOrConnectionFilter = new ArrayList<Object>();
        }
        return this.bridgeFactoryOrBrokerServiceOrConnectionFilter;
    }
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            List<Object> theBridgeFactoryOrBrokerServiceOrConnectionFilter;
            theBridgeFactoryOrBrokerServiceOrConnectionFilter = (((this.bridgeFactoryOrBrokerServiceOrConnectionFilter!= null)&&(!this.bridgeFactoryOrBrokerServiceOrConnectionFilter.isEmpty()))?this.getBridgeFactoryOrBrokerServiceOrConnectionFilter():null);
            strategy.appendField(locator, this, "bridgeFactoryOrBrokerServiceOrConnectionFilter", buffer, theBridgeFactoryOrBrokerServiceOrConnectionFilter);
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            List<Object> theBridgeFactoryOrBrokerServiceOrConnectionFilter;
            theBridgeFactoryOrBrokerServiceOrConnectionFilter = (((this.bridgeFactoryOrBrokerServiceOrConnectionFilter!= null)&&(!this.bridgeFactoryOrBrokerServiceOrConnectionFilter.isEmpty()))?this.getBridgeFactoryOrBrokerServiceOrConnectionFilter():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "bridgeFactoryOrBrokerServiceOrConnectionFilter", theBridgeFactoryOrBrokerServiceOrConnectionFilter), currentHashCode, theBridgeFactoryOrBrokerServiceOrConnectionFilter);
        }
        {
            BigInteger theAdvisoryAckPercentage;
            theAdvisoryAckPercentage = this.getAdvisoryAckPercentage();
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            List<Object> lhsBridgeFactoryOrBrokerServiceOrConnectionFilter;
            lhsBridgeFactoryOrBrokerServiceOrConnectionFilter = (((this.bridgeFactoryOrBrokerServiceOrConnectionFilter!= null)&&(!this.bridgeFactoryOrBrokerServiceOrConnectionFilter.isEmpty()))?this.getBridgeFactoryOrBrokerServiceOrConnectionFilter():null);
            List<Object> rhsBridgeFactoryOrBrokerServiceOrConnectionFilter;
            rhsBridgeFactoryOrBrokerServiceOrConnectionFilter = (((that.bridgeFactoryOrBrokerServiceOrConnectionFilter!= null)&&(!that.bridgeFactoryOrBrokerServiceOrConnectionFilter.isEmpty()))?that.getBridgeFactoryOrBrokerServiceOrConnectionFilter():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "bridgeFactoryOrBrokerServiceOrConnectionFilter", lhsBridgeFactoryOrBrokerServiceOrConnectionFilter), LocatorUtils.property(thatLocator, "bridgeFactoryOrBrokerServiceOrConnectionFilter", rhsBridgeFactoryOrBrokerServiceOrConnectionFilter), lhsBridgeFactoryOrBrokerServiceOrConnectionFilter, rhsBridgeFactoryOrBrokerServiceOrConnectionFilter)) {
                return false;
            }
        }
        {
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DtoLdapNetworkConnector.BridgeFactory)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DtoLdapNetworkConnector.BridgeFactory that = ((DtoLdapNetworkConnector.BridgeFactory) object);
            {
                List<Object> lhsAny;
